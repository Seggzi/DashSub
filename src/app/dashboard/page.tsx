                        ...
                        {profile && profile.monnify_accounts && Array.isArray(profile.monnify_accounts) && profile.monnify_accounts.length > 0 ? (
                            <div className="bg-brand-mint/5 border border-brand-mint/10 rounded-[2rem] p-6 flex flex-col justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-brand-gray/60 mt-2">{profile.monnify_accounts[0].accountName}</p>
                            ...
                            <div className="bg-brand-mint/5 border border-brand-mint/10 rounded-[2rem] p-6 text-center flex flex-col justify-center">
                                <CreditCard className="w-12 h-12 text-brand-mint/40 mx-auto mb-3" />
                                <p className="text-sm font-bold text-brand-gray/60 mb-2">Get Virtual Account</p>
                                <p className="text-xs text-brand-gray/40 mb-4">
