                ...
                notifications.slice(0, 10).map(n => {
                  ...
                  return (
                    <div key={n.id} className="notif-row"
                      ...
                      style={{ padding: '12px 16px', borderBottom: '1px solid rgba(255,255,255,0.04)', display: 'flex', gap: 11, alignItems: 'flex-start', background: n.is_read ? 'transparent' : 'rgba(83,230,212,0.03)' }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 6, marginBottom: 3 }}>
                          <p style={{ fontSize: 13, fontWeight: n.is_read ? 600 : 800, color: n.is_read ? 'rgba(244,247,247,0.65)' : '#F4F7F7', lineHeight: 1.3 }}>{n.title}</p>
                          {!n.is_read && <span style={{ width: 6, height: 6, borderRadius: '50%', background: '#53E6D4', flexShrink: 0, marginTop: 4 }} />}
                        </div>
